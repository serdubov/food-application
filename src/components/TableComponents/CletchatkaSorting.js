...
function CletchatkaSorting ({addToTable, showCletchatka, showProtein, showBev, showUglevod, onDelete} ) {
    return (
        addToTable.sort((a,b)=>b.cletchatkaValue-a.cletchatkaValue).map((obj) => {
            return (
            <tbody>
                <td>
...
export default CletchatkaSorting;